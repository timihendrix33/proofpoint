...
jQuery(document).ready(function($) {
	...
	$('.main-menu-new').children().clone().removeAttr('id').appendTo($(sidebar)).addClass("primary-sidebar");
	$('.secondary-menu, .sidebar-mobile').children().clone().prepend("<li class='label'>Industries</li>").removeAttr('id').appendTo($(sidebar));
	...
	/* Down arrow link */
	$('.promo .get-started').click(function(){
		var promoHeight = $('.promo').height();
		$('html, body').animate({scrollTop:promoHeight}, 'fast');
		return false;
	});
