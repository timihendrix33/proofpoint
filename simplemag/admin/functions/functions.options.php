...
$of_options[] = array( 	
					"name" => "Sidebar Behaviour in Mobile",
...
$of_options[] = array( 	
					"name" => "Excerpt Length",
					"desc" => "Enter a number of words to limit the exceprt site wide.",
...
$of_options[] = array( 	
					"name" => "Comments in static pages",
					"desc" => "Enable or Disable comments in all static pages. Default: Disable.",
...
$of_options[] = array( 	
					...
					"desc" => "Select the size of the main menu parent links",
					"id" => "main_menu_links",
					"std" => "18px",
					"type" => "select",
...
$of_options[] = array( 	
					"name" => "Slider Tint Strength",
					"desc" => "Default. Select the default strength for sliders tint effect.",
...
$of_options[] = array( 	
					"name" => "",
					"desc" => "Hover. Select the hover strength for sliders tint effect.",
...
$media_position = array("fullwidth" => "Full Width", "abovecontent" => "Above the Content", "useperpost" => "Define Per Post");
$of_options[] = array( 	
					"name" => "Media Position",
					"desc" => "<b>Please Note!</b><br />'Full Width' & 'Above the Content' will work site wide. 'Define Per Post' works individually on every post. If you select this option, navigate to your exstining post, select the desired option in 'Post Options' box and update it. 'Above the Content' option does not support Gallery post format.",
...
$of_options[] = array( 	
					...
					"desc" => "",
					"id" => "post_score",
					"std" => "<h3 style=\"margin: 0;\">Post Score</h3>",
					"icon" => false,
					"type" => "info"
				);
...
$of_options[] = array( 	
					"name" => "Top Strip Social Profiles",
					"desc" => "Enable or Disable top strip socical profiles with one click. Default: Disable",
...
$of_options[] = array( "name" => "Enter full URL of your profiles",
					"desc" => "RSS Feed",
					"id" => "sp_feed",
					"std" => "",
					"type" => "text");
...
$of_options[] = array( 	
					...
					"desc" => "Paste here JavaScript and/or Analytics code wich will appear in the Header of your site. <strong>DO NOT</strong> include opening and closing script tags.",
					"id" => "custom_js_header",
					"std" => "",
					"type" => "textarea"
				);
...
$of_options[] = array( 	
					...
					"desc" => "Paste JavaScript and/or Analytics code wich will appear in the Footer of your site. <strong>DO NOT</strong> include opening and closing script tags.",
					"id" => "custom_js_footer",
					"std" => "",
					"type" => "textarea"
				);
