    ...
    <header id="masthead" role="banner" class="clearfix">
		...
		<div class="top-strip <?php echo $ti_option['site_top_strip_color']; if ( $ti_option['site_top_strip'] == 0 ) { echo ' hide-strip'; } ?>">
                ...
                <a class="logo" href="<?php echo home_url( '/' ); ?>">
                    <span class="helper"></span><img src="<?php echo $site_logo; ?>" alt="<?php bloginfo( 'name' ); ?> - <?php bloginfo( 'description' ); ?>" title="<?php bloginfo( 'name' ); ?> - <?php bloginfo( 'description' ); ?>" />
                </a>
                <!-- End Logo -->
        ...
        <div class="search">  
          <?php get_search_form(); ?>    
          <div class="mailto">
            <a href="mailto:ann.newland@havasww.com?subject=Contribution to Proofpoint"><span class="contribute">Contribute Content</span></a>
          </div>   
        </div>           
    </header><!-- #masthead -->
    <div id="pageslide">
