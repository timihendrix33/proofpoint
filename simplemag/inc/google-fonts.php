...
if ( $ti_customfont != "" ) {
	function google_font() {
		...
		wp_enqueue_style( 'google-fonts', "$protocol://fonts.googleapis.com/css?subset=latin,latin-ext,cyrillic,cyrillic-ext&family=". substr_replace( $ti_customfont,"",-1 ) . " rel='stylesheet' type='text/css" );
	}
